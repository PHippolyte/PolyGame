...
public abstract class Spell {
	public enum TypeSpell{CHARGE, DIVINESHIELD, DODGEBOOST, FIREBALL, LONGATTACK, MAGICBOOST, METEORE, MULTIARROW, MULTIATTACK, POWERHEAL, RANGEBOOST, REANIMATION, ROOT, SPRINT, THROWS, UNSTOPABLEATTACK, ZONEHEAL, LESSACTION, MOREACTION, ICEFIELD}
